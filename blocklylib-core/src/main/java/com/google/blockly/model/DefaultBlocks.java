...
public final class DefaultBlocks {
    ...
    public static final String INPUT_CATEGORY_NAME = "INPUT";
    public static final String BASIC_CATEGORY_NAME = "BASIC";
    public static final String ROBOT_CATEGORY_NAME = "ROBOT";
    ...
    public static final String BASIC_BLOCKS_PATH = "default/basic_blocks.json";
    public static final String INPUT_BLOCKS_PATH = "default/input_blocks.json";
    public static final String ROBOT_BLOCKS_PATH = "default/robot_blocks.json";
    ...
    public static Map<String, CustomCategory> getToolboxCustomCategories(
		...
		map.put(BASIC_CATEGORY_NAME, new ProcedureCustomCategory(controller));
        map.put(INPUT_CATEGORY_NAME, new ProcedureCustomCategory(controller));
        map.put(ROBOT_CATEGORY_NAME, new ProcedureCustomCategory(controller));
