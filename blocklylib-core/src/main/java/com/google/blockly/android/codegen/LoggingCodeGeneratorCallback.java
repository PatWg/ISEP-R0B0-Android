...
public class LoggingCodeGeneratorCallback implements CodeGenerationRequest.CodeGeneratorCallback {
    ...
    protected final AbstractBlocklyActivity mActivity;

    public LoggingCodeGeneratorCallback(Context context, String loggingTag, AbstractBlocklyActivity activity) {
        mTag = loggingTag;
        mContext = context;
        mActivity = activity;
    }
    ...
    public void onFinishCodeGeneration(String generatedCode) {
        ...
        if (generatedCode.isEmpty()) {
            ...
            mActivity.codeIsGenerated(generatedCode);
        }
    }
}
